...
const Navbar = () => {
    ...
    useEffect(() => {
        const handleScroll = () => {
            ...
            if (scrollTop > 100) {
                setScrolled(true); // If scrolled beyond 100 pixels, set scrolled state to true
            } else {
        ...
        >
            <div className='w-full flex justify-between items-center max-w-7xl mx-auto '>
                ...
                <Link
                    ...
                    onClick={() => {
                        setActive(""); // Reset the active link
                ...
                <ul className='list-none hidden sm:flex flex-row gap-10'>
                    {navLinks.map((nav) => (
                        <li
                            ...
                            onClick={() => setActive(nav.title)} // Set the active link when clicked
                        >
